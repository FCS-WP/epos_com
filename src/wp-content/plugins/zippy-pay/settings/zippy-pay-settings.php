...
class ZIPPY_Pay_Settings extends WC_Settings_Page
{
  ...
  public function __construct()
  {
    ...
    $this->id_2c2p_tab  = 'woocommerce_' .  PAYMENT_2C2P_ID . '_settings';
  ...
  public function get_sections()
  {
    ...
    $has_2c2p_tab =  $this->get_payment_status($this->id_2c2p_tab, true);
    ...
    if (isset($has_2c2p_tab) && $has_2c2p_tab == "yes") {
      $sections['zippy_2c2p'] = __('EPOSPay 2C2P', PREFIX . 'zippy-settings-tab');
    }
    ...
    switch ($section) {
      ...
      case 'zippy_2c2p':
        ...
        $settings = array(
          'section_title' => $this->show_warning_message(),
          'divider' => ZIPPY_Pay_Core::divider(),
          'enable_zippy_2c2p'         => array(
            'title'   => __('Enable EPOSPay 2C2P', PREFIX . 'zippy-settings-tab'),
            'type'    => 'checkbox',
            'label'   => __('Enable EPOSPay 2C2P', PREFIX . 'zippy-settings-tab'),
            'default' => 'no',
            'id'      =>   $this->id_2c2p_tab,
            'value'   => $this->get_payment_status($this->id_2c2p_tab)
          ),
          'zippy_2c2p_field'         => array(
            'id'       => 'zippy_2c2p_field',
            'type'      => 'zippy_2c2p_field',
            'default' => '',
          ),
          // 'divider' => ZIPPY_Pay_Core::divider(),
          'section_end' => array(
            'type' => 'sectionend',
            'id' => 'zippy_settings_tab_end_2c2p'
          )
        );
        break;
  ...
  protected function show_warning_message()
  {
    $settings_title = array(
      ...
      'type'     => 'title',
      'desc'     => __('This configuration Integrates with EPOSPay Antom & EPOSPay Paynow <span style="color: #cc0000;display: block;">
