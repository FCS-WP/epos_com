...
$sub_v2_tools = [
  [
    ...
    'card_class' => 'sub-v2-tools__card--flip-bg',
  ],
  [
  ...
  [
    'title' => 'Run Your Google Business Profile',
    'desc' => 'Easily manage everything you need to succeed on Google.',
    'bullets' => [
      'Update business information and create events',
      'Manage reviews and share your menu',
    ],
  ...
  <div class="sub-shell">
    <div class="sub-v2-tools__head" data-animate-group="section-head">
      ...
      <h2 class="sub-v2-tools__title sub-v2-section-title">
        The Right Tools
        <span>For Small Business That Want To Grow</span>
      </h2>
    </div>
  </div>
  ...
  <div class="sub-v2-tools__slider-wrap" data-animate="fade-up">
    <div class="sub-v2-tools__grid" data-sub-v2-tools-slider>
      <?php foreach ($sub_v2_tools as $tool) : ?>
        ...
        <article class="sub-v2-tools__card <?php echo esc_attr($tool['card_class']); ?>">
